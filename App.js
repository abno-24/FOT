...
const resList = [
  {
    ...
    analytics: {
      context: "seo-data-525ad34b-487b-4a44-8b92-1d1bc98c698e",
    },
    cta: {
  ...
  },
  {
    ...
    cta: {
      link: "https://www.swiggy.com/restaurants/ubq-by-barbeque-nation-marol-times-square-mumbai-645234",
      text: "RESTAURANT_MENU",
      type: "WEBLINK",
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
  },
  {
    ...
    cta: {
      link: "https://www.swiggy.com/restaurants/box8-desi-meals-mahakali-andheri-e-andheri-east-mumbai-289315",
      text: "RESTAURANT_MENU",
      type: "WEBLINK",
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-03-16 21:31:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
    ...
    cta: {
      link: "https://www.swiggy.com/restaurants/monginis-pleasant-park-andheri-east-mumbai-757974",
      text: "RESTAURANT_MENU",
      type: "WEBLINK",
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-03-16 22:50:00",
        opened: true,
      },
      badges: {
        imageBadges: [
    ...
    cta: {
      link: "https://www.swiggy.com/restaurants/dabba-garam-homestyle-combo-thali-and-more-rajeer-royals-andheri-east-mumbai-573325",
      text: "RESTAURANT_MENU",
      type: "WEBLINK",
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
  },
  {
    ...
    cta: {
      link: "https://www.swiggy.com/restaurants/la-pinoz-pizza-mahakaki-rd-andheri-east-mumbai-454644",
      text: "RESTAURANT_MENU",
      type: "WEBLINK",
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
...
const CardContainer = () => {
  return (
    <div className="rest-card-list">
      {resList.map((rest) => {
        return <RestoCards key={rest.info.id} {...rest.info} />;
      })}
    </div>
  );
};
